      ...
      <Grid>
        <Row>
          ...
          <Col xs={10} md={5} xsOffset={1} mdOffset={0}>
            ...
            <h4 className="profile-content">I love learning about anything new and different so reach out if you have an opportunity. I am actively looking for a 2019 Summer Internship or a part time project during the school year. Email me at Jwlin17@gmail.com!</h4>
          </Col>
        </Row>
      </Grid>
    );
